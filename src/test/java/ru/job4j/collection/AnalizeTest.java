...
class AnalizeTest {
    ...
    @Test
    void whenAllUsersNew() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(new User(7, "G"), new User(6, "F"), new User(5, "E"), new User(4, "D"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(4, 0, 3));
    }
    ...
    @Test
    void whenAllChangedAndPrevGreaterThanCur() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        User u4 = new User(10, "O");
        User u5 = new User(11, "P");
        User u6 = new User(12, "U");
        Set previous = Set.of(u1, u2, u3, u4, u5, u6);
        Set current = Set.of(new User(1, "AA"), u2, new User(4, "D"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(1, 1, 4));
    }
}